...
sudo apt-get update
sudo apt-get install ethereum ethminer geth build-essentia
...
sudo ./NVIDIA-Linux-x86_64-375.20.run --accept-license --no-questions --disable-nouveau --no-install-compat32-libs
